Technical test by Carmen Jimenez Sampériz for W2M consisting of an application that lists, modifies, deletes and edits heroes. Possibility to search filtering by name.
